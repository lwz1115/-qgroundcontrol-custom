...
void QGCMAVLinkTest::_testVehicleClassToString()
{
    ...
    QCOMPARE(QGCMAVLink::vehicleClassToUserVisibleString(QGCMAVLink::VehicleClassRoverBoat), QStringLiteral("Unmanned Surface Vessel"));
    ...
    QCOMPARE(QGCMAVLink::vehicleClassToCanonicalString(QGCMAVLink::VehicleClassRoverBoat), QStringLiteral("Unmanned Surface Vessel"));
}
...
void QGCMAVLinkTest::_testVehicleTypeFromString()
{
    ...
    QCOMPARE(QGCMAVLink::vehicleTypeFromString(QStringLiteral("Unmanned Surface Vessel")), MAV_TYPE_GROUND_ROVER);
    QCOMPARE(QGCMAVLink::vehicleTypeFromString(QStringLiteral("USV")), MAV_TYPE_GROUND_ROVER);
    QCOMPARE(QGCMAVLink::vehicleTypeFromString(QStringLiteral("Unknown")), MAV_TYPE_GROUND_ROVER);
