...
elseif(MINGW)
    # MinGW/GCC：使用 COFF bigobj 对象格式，避免 mocs_compilation.cpp
    # 触发 GNU as 的 "too many sections" / "file too big" 汇编错误
    # （等价于 MSVC 的 /bigobj，见上方 if(MSVC) 分支）。
    # 注：windres 命令行过长的修复（RC response file）在顶层 CMakeLists.txt
    # 的 project() 之前设置，见其中的 "Windows RC Compiler Response Files"。
    target_compile_options(${CMAKE_PROJECT_NAME}
        PRIVATE
            -Wa,-mbig-obj
    )
